...
public class SecurityDefinitionMessageParser extends OmdMessageParser<SecurityDefinitionMessage> {
    ...
    protected SecurityDefinitionMessage doParseMessageBody(ByteBuf msgBodyBuf, SecurityDefinitionMessage msg)
        ...
        msg.lotSize = msgBodyBuf.readUnsignedInt();    // uint32
        msgBodyBuf.readBytes(msg.filler4); // byte4
        //
        msg.previousClosingPrice = msgBodyBuf.readInt(); // int32
        ...
        //
        msg.listingDate = msgBodyBuf.readInt();    // uint32
        msg.delistingDate = msgBodyBuf.readInt();    // uint32
        ...
        msg.accruedInterest = msgBodyBuf.readUnsignedInt();    // uint32
        msg.couponRate = msgBodyBuf.readUnsignedInt(); // uint32
        msgBodyBuf.readBytes(msg.filler42);
        //
        msg.conversionRatio = msgBodyBuf.readUnsignedInt();    // uint32
        msg.strikePrice = msgBodyBuf.readInt();    // int32
        msg.strikePrice2 = msgBodyBuf.readInt();    // int32
        msg.maturityDate = msgBodyBuf.readInt();    // uint32
        ...
        msg.callPrice = msgBodyBuf.readInt();    // int32
        msg.decimalsInCallPrice = msgBodyBuf.readUnsignedByte(); // unit8
        msg.entitlement = msgBodyBuf.readInt(); // int32
        msg.decimalsInEntitlement = msgBodyBuf.readUnsignedByte(); // unit8
        msg.noWarrantsPerEntitlement = msgBodyBuf.readUnsignedInt(); // uint32
        msgBodyBuf.readBytes(msg.filler33);    // byte33
        msg.noUnderlyingSecurities = msgBodyBuf.readUnsignedShort(); // uint16
        //
        if (msg.noUnderlyingSecurities > 0) {
            ...
            for (int i = 0; i < msg.noUnderlyingSecurities; i++) {
                ...
                entry.underlyingSecurityCode = msgBodyBuf.readInt();    // uint32
                entry.underlyingSecurityWeight = msgBodyBuf.readUnsignedInt();    // uint32
