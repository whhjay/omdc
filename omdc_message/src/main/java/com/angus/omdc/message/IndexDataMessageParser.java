...
public class IndexDataMessageParser extends OmdMessageParser<IndexDataMessage> {
	...
	protected IndexDataMessage doParseMessageBody(ByteBuf msgBodyBuf, IndexDataMessage msg) throws Exception {
		...
		msg.indexTime = msgBodyBuf.readLong(); // int64
		msg.indexValue = msgBodyBuf.readLong(); // int64
		msg.netChgPrevDay = msgBodyBuf.readLong(); // int64
		msg.highValue = msgBodyBuf.readLong(); // int64
		msg.lowValue = msgBodyBuf.readLong(); // int64
		msg.easValue = msgBodyBuf.readLong(); // int64
		msg.indexTurnover = msgBodyBuf.readLong(); // int64
		msg.openingValue = msgBodyBuf.readLong(); // int64
		msg.closingValue = msgBodyBuf.readLong(); // int64
		msg.previousSesClose = msgBodyBuf.readLong(); // int64
		msg.indexVolume = msgBodyBuf.readLong(); // int64
		msg.netChgPrevDayPct = msgBodyBuf.readInt(); // int32
